        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-800">
            <Button 
              ...
              size="lg"
              className="bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 dark:text-gray-900 hover:from-gray-800 hover:to-gray-600 dark:hover:from-white dark:hover:to-gray-200 transition-all duration-300 text-lg px-8 py-3 hover-lift"
            >
              View My Work
            </Button>
            <Button 
              ...
              variant="outline"
              size="lg"
              className="border-2 border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 text-lg px-8 py-3 hover-lift"
            >
              Book a Session
            </Button>
          </div>
